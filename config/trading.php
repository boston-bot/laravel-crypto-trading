...
return [
    ...
    'allowed_assets' => array_values(array_filter(array_map('trim', explode(',', env('TRADING_ALLOWED_ASSETS', 'BTC,ETH'))))),
    'max_open_positions' => (int) env('MAX_OPEN_POSITIONS', 1),
    'max_position_notional_usd' => (float) env('MAX_POSITION_NOTIONAL_USD', 15),
    ...
    'sizing' => [
        'base_risk_pct' => (float) env('SIZING_BASE_RISK_PCT', 0.0075),
        ...
        'max_position_pct_of_equity' => (float) env('SIZING_MAX_POSITION_PCT_EQUITY', 0.25),
    ],
    'paper' => [
